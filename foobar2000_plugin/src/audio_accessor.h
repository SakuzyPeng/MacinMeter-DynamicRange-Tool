...
class AudioAccessor {
  public:
    ...
    decode_audio_data_list(const pfc::list_base_const_t<metadb_handle_ptr>& handles);
    ...
    analyze_dr_data_list(const pfc::list_base_const_t<metadb_handle_ptr>& handles);

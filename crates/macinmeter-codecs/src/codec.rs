...
use symphonia::core::codecs::{
    CODEC_TYPE_ALAC, CODEC_TYPE_FLAC, CODEC_TYPE_PCM_F32BE, CODEC_TYPE_PCM_F32BE_PLANAR,
    ...
    CODEC_TYPE_PCM_S8, CODEC_TYPE_PCM_S8_PLANAR, CODEC_TYPE_PCM_S16BE, CODEC_TYPE_PCM_S16BE_PLANAR,
    ...
    CODEC_TYPE_PCM_S32LE_PLANAR, CODEC_TYPE_PCM_U8, CODEC_TYPE_PCM_U8_PLANAR, CODEC_TYPE_PCM_U16BE,
    ...
    CODEC_TYPE_PCM_U32LE, CODEC_TYPE_PCM_U32LE_PLANAR, CodecParameters, CodecType,
};
...
pub(crate) fn validate_codec(
    ...
    let source_codec = match signature {
        ...
        ContainerSignature::Mp4 if codec == CODEC_TYPE_ALAC => SourceCodec::Alac,
        ...
        _ => {
            return Err(analysis_error(
                ...
                AnalysisStage::Probe,
                "container codec is outside the stable PCM/FLAC/ALAC support set",

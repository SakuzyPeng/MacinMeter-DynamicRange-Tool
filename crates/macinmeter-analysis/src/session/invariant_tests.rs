    ...
    fn from(session: &AnalyzerSession) -> Self {
        ...
        Self {
            ...
            algorithm: AlgorithmBits {
                ...
                float_parameters: [
                    window_duration_coefficient.to_bits(),
                    rms_sum_multiplier.to_bits(),
                    rms_histogram_min_db.to_bits(),
                    rms_histogram_max_db.to_bits(),
                    histogram_bin_width_db.to_bits(),
                    peak_key_bin_width_db.to_bits(),
                    loud_fraction.to_bits(),
                    dr_floor_db.to_bits(),
                    silent_channel_dr_db.to_bits(),
                ],
